<div class="container container-web-page">
    ...
    <p class="text-justify">Al crear una cuenta en nuestro sitio web usted acepta nuestros términos y condiciones</a>. La información introducida en el formulario debe de ser clara, precisa y legitima. Para crear una cuenta debe de llenar todos los campos que son obligatorios marcados con el icono <?php echo FIELD_OBLIGATORY; ?></p>
    <hr>
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                                    ...
                                    <label for="cliente_nombre" class="form-label">Nombre <?php echo FIELD_OBLIGATORY; ?></label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                                    ...
                                    <label for="cliente_provincia" class="form-label">Estado o provincia <?php echo FIELD_OBLIGATORY; ?></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                                    ...
                                    <label for="cliente_direccion" class="form-label">Calle <?php echo FIELD_OBLIGATORY; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
